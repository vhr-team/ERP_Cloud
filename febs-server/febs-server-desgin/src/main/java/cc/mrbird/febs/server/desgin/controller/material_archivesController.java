package cc.mrbird.febs.server.desgin.controller;

import cc.mrbird.febs.server.desgin.entity.Response;
import cc.mrbird.febs.server.desgin.entity.material_archives;
...
import cc.mrbird.febs.server.desgin.service.design_materialService;
import cc.mrbird.febs.server.desgin.service.design_recordService;
import cc.mrbird.febs.server.desgin.service.material_archivesService;
    ...
    public Response addarchives(@RequestBody material_archives archives) {
        ...
        try {
            ...
            if (i > 0) {
                ...
                for (product_material_archives product_material_archive : product_material_archives) {
